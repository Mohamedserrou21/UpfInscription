...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ url('css/fsi.css') }}">
...
<body>
	...
	<section class="about">
		<div class="main">
			<img src= "{{ url('image/fsi2.png') }}">
			<div class="about-text">
				<h2>FSI</h2>
				<h5> Faculté Des <span>Sciences De L'Ingénieur</span></h5>
				<p>Dans le contexte général des transformations socio-économiques et politiques que connait notre pays, l’Université Privée de Fès se positionne comme un acteur principal de développement en contribuant à la réussite des grands programmes structurants du Maroc ainsi que leurs déclinaisons régionales. Pour ce faire, la Faculté des Sciences de l’Ingénieur (FSI), composante de l’Université Privée de Fès, met en œuvre ses objectifs en cohérence avec la stratégie globale de développement de l’UPF, touchant à la formation, à la recherche, à la vie étudiante, au rayonnement à l’international, à la gouvernance de l’université
