...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ url('css/fbs.css') }}">
...
<body>
	...
	<section class="about">
		<div class="main">
			<img src= "{{ url('image/FBS.png') }}">
			<div class="about-text">
				<h2>FBS</h2>
				<h5>Fès<span> Business School</span></h5>
				<p>Dans un monde en perpétuelle évolution, la Fès Business School innove constamment et procède aux adaptations nécessaires afin de proposer les programmes d’enseignement supérieur de haute qualité, adaptés aux besoins des entreprises et aux envies des étudiants. De la richesse de son expertise, de ses mutations et de ses partenariats, elle garde le meilleur pour progresser et mener sa double mission de formation au haut enseignement managérial et de service au territoire en formant les cadres et dirigeants de ses entreprises.
